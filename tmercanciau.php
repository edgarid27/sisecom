...
<head>
    ...
    function ExportToExcel(tmercancia){
           var htmltable= document.getElementById('tmercancia');
    ...
    <script type="text/javascript">
        function Redireccionar(){ 
            location.href ="php/pdf/genPDFTMer.php";
        };
    </script>
...
<body>
    ...
    <div class="table-responsive">
      <table id="tmercancia" class="table table-condensed table-hover table-striped" width="100%" cellspacing="0" >
            <thead>
                <tr>
       ...
       <div class="col-md-12">
           <button type="button" style="margin-left: 10px;" class="btn  pull-right clearfix btn-success" onclick="ExportToExcel('tmercancia', 'W3C Example Table')" value="Export to Excel"><span class="fa fa-file-excel-o" style="margin-left: 10px;"></span> Exportar a Excel</button>
    ...
    <form id="formal">
        <div class="form-group">
            <label for="id">ID del tipo de mercancia:</label><br />
			<input type="text" class="form-control" id="xid" name="xid" placeholder="ID del tipo de mercancia" readonly="readonly" />
		</div>
