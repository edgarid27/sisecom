...
session_start();
    ...
    $shsq5 ="SELECT id, estado FROM `estado` where estatus = 1 order by estado";
...
<body>
      ...
      <table id="mercancia" class="table table-condensed table-hover table-striped" width="100%" cellspacing="0" >
            <thead>
                <tr>
                    ...
                    <th data-column-id="tipomercancia">T. de Mercancia</th>
                    <th data-column-id="descripciones">Categoria</th>
      ...
      <table id="altas" class="table table-condensed table-hover table-striped" width="100%" cellspacing="0" >
            <thead>
                <tr>
                    ...
                    <th data-column-id="cantidad">Cantidad</th>
                    <th data-column-id="tipomercancia">Categoria</th>
    ...
    <form id="formal">
        ...
        <div class="form-group">
            <label for="cant">Cantidad a agregar:</label><br />
			<input type="numeric" class="form-control" id="xcant" onkeypress="return soloNumeros(event)" name="xcant" placeholder="Cantidad a agregar" />
		</div>
        
        <div class="form-group">
        <label for="Descripcion">Tipo de mercancia:</label>
        <select name="xdescripcion" id="xdescripcion" disabled="" class="form-control">
