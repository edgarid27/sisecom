...
<body>
      ...
      <table id="herramienta" class="table table-condensed table-hover table-striped" width="100%" cellspacing="0" >
            <thead>
                <tr>
                    ...
                    <th data-column-id="totale">CTE</th>
    ...
    <form id="formal" method="POST">
        <div class="form-group">
            <label for="id">ID de la herramienta:</label><br />
    ...
    <div class="form-group">
        ...
        <div class="form-group">
			...
			<input type="file" class="form-control" id="ximagen" name="ximagen" placeholder="Imagen de la herramiena"/>
		</div>
