...
<head>
    ...
    <script type="text/javascript">
        function Redireccionar(){ 
            location.href ="php/pdf/genPDFMerc.php";
        };
    </script>
...
<body>
    ...
    <form id="formal" method="POST">
        <div class="form-group">
			...
			<input type="text" class="form-control" id="xid" name="xid" placeholder="ID de la mercancia" readonly="readonly" />
		</div>
        
        <div class="form-group">
        <label for="Mercancia">Mercnacia:</label>
