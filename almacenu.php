...
<body>
    ...
    <header class="page-header dropdown-header modal-header" >
     ...
     <div class="table-responsive">
      <table id="almacen" class="table table-condensed table-hover table-striped" width="100%" cellspacing="0" >
            <thead>
                <tr>
                    <th data-column-id="id">ID</th>
                    <th data-column-id="almacen">Seccion</th>
    ...
    <form id="formal" method="POST">
        ...
        <div class="form-group">
			...
			<input type="text" maxlength="50" class="form-control" onkeypress="return soloLetras(event)" id="xalmacen" name="xalmacen" placeholder="Almacen" />
		</div>
