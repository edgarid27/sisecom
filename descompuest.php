...
<head>
    ...
    <script src="js/descompueston.js"></script>
...
<body>
    ...
    <form id="formal" method="POST">
        ...
        <div class="form-group">
			...
			<input type="text" maxlength="50" onkeypress="return soloLetras(event)" class="form-control" id="xherramienta" name="xherramienta"  placeholder="Herramienta"/>
		</div>
        
        <div class="form-group">
            <label for="descripcion">Descripción de la herramienta:</label><br />
            <textarea type="text" maxlength="250" onkeypress="return soloLetras(event)" class="form-control" id="xdescripcion" name="xdescripcion" placeholder="Descripción de la herramienta"></textarea>
		</div>
        ...
        <div class="form-group">
			...
			<input type="text" maxlength="50" class="form-control" onkeyup="mayus(this)" id="xmodelo" name="xmodelo" placeholder="Modelo de la herramienta"/>
		</div>
        ...
        <div class="form-group">
            <label for="modelo">Cantidad existente de la herramienta (que funciona):</label><br />
        ...
        <div class="form-group">
            <label for="razon">Razon de falla:</label><br />
            <textarea class="form-control" onkeypress="return soloLetras(event)" id="xrdf" name="xrdf" maxlength="115" placeholder="Razon de falla"></textarea>
        </div>

        <div class="form-group">
            <label for="cantidadf">Cantidad de herramienta (que esta fallando):</label><br />
            <input type="text" class="form-control" onkeypress="return soloNumerospat(event)" id="xcantf" name="xcantf" placeholder="Razon de falla"/>
        </div>
