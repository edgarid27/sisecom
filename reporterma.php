...
<head>
    ...
    <script type="text/javascript">
        function Redireccionar(){ 
            if($('#xidrma').val()=="")
            {
                alert("Introduce el ID del RMA para generar PDF.");
                return false;
            }
            else
            {
                if($('#xidrma').val()<=0)
                {
                    alert("Introduce un ID valido del RMA.");
                    return false;
                }
                else
                {
            ...
            location.href ="php/pdf/genRMA.php?value="+con;
        };
    </script>
            ...
            <table id="rma" class="table table-condensed table-hover table-striped" width="100%" cellspacing="0" >
                <thead>
                    <tr>
                        ...
                        <th data-column-id="commands" data-formatter="commands" data-sortable="false">Mandar reporte.</th>
                    </tr>
                </thead>
           </table>
       <span id="resdlt"></span>
       ...
       <br />
        ...
        <form id="formal" method="post">
            ...
            <div class="form-group">
                ...
                <input type="numeric" id="xidrma" name="xidrma" class="form-control" placeholder="Numero de orden" readonly="readonly">
            </div>

            <div class="form-group">
                <label for="norden">Numero de orden:</label>
                <input type="numeric" id="xnorden" name="xnorden" class="form-control" placeholder="Numero de orden" readonly="readonly">
            </div>

            <div class="form-group">
            <label for="iduser">Proveedor:</label>
            <select name="xprovee" id="xprovee" class="form-control" disabled="disabled">
            ...
            <select id="xcliente" name="xcliente" class="form-control" disabled="disabled">
                <option value="0">SELECCIONE</option>
                <?php
                ...
                <table class="table table-condensed table-hover table-striped" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-left">RMA proveedor</th>
                    ...
                    <tbody id="col1" class="hidden">
                        <tr>
                            ...
                            <td class="text-left">
                            <div class="form-group">
                                <input type="text" class="form-control" id="xproducto1" name="xproducto1" readonly="" />
                            </div>
                            </td> 

                            <td class="text-left">
                            <div class="form-group-sm">
                                <input type="text" class="form-control" id="xmodelo1" name="xmodelo1" readonly="" />
                            </div>
                            </td>

                            <td class="text-left">
                            <div class="form-group-sm">
                                <input type="text" class="form-control" id="xserie1" name="xserie1" readonly="" />
                            </div>
                            </td>

                            <td class="text-left">
                            <div class="form-group-sm">
                                <textarea class="form-control" id="xrazon1" name="xrazon1" readonly=""></textarea>
                            </div>
                            </td>

                            <td class="text-left">
                            <div class="form-group">
                                <input type="text" class="form-control" id="xrmap1" name="xrmap1" maxlength="15" readonly="" />
                            </div>
                            </td>

                            <td class="text-left">
                            <div class="form-group-sm">
                                <input type="date" class="form-control" id="xdateig1" name="xdateig1" readonly="" />
                            </div>
                            </td>

                            <td class="text-left">
                            <div class="form-group-sm">
                                <input type="date" class="form-control" id="xdateen1" name="xdateen1" readonly="" />
                            </div>
                            </td>

                            <td class="text-left">
                            <div class="form-group-sm">
                                <input type="date" class="form-control" id="xdatere1" name="xdatere1" readonly="" />
                            </div>
                            </td>

                            <td class="text-left">
                            <div class="form-group-sm">
                                <input type="date" class="form-control" id="xdateis1" name="xdateis1" readonly="" />
                            </div>
                            </td>

                            <td class="text-left">
                            <div class="form-group-sm" >
                                <select name="xec1" id="xec1" class="form-control" disabled="disabled">
                                    <option value="0">SELECCIONE</option>
            ...
            <div id="botonce" class="from-group">
                <button type="button" class="btn  form-control btn-danger clearfix" onclick ="Redireccionar()"><span class="fa fa-file-pdf-o"></span> Generar PDF</button>
            </div>
        </form>
