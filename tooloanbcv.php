...
<head>
    ...
    <script src="js/tooloanbcv.js"></script>
            ...
            <table class="table table-condensed table-hover table-striped" width="100%" cellspacing="2">
                <thead>
                    <tr>
                        ...
                        <th class="text-left">Herramienta a agregar/retirar</th>
                ...
                <tbody id="col1" class="hidden">
                    <tr>
                        ...
                        <td class="text-left">
                            <div class="form-group-sm">
                                <input type="number" class="form-control-feedback" id="xcnp1" name="xcnp1" readonly="" />
                            </div>
                        </td>

                        <td class="text-left">
                            <div class="form-group-sm">
                                <input type="number" class="form-control-feedback" id="xnloan1" name="xnloan1" onkeypress="return soloNumeros()" />
                            </div>
                        </td>

                        <td class="text-left">
                            <div class="form-group-sm">
                                <textarea maxlength="150" class="form-control-feedback" onkeypress="return soloLetas(event)" id="xcoment1" name="xcoment1"></textarea>
                            </div>
                        </td>
                ...
                <tbody id="col2" class="hidden">
                    <tr>
                        ...
                        <td class="text-left">
                            <div class="form-group-sm">
                                <input type="number" class="form-control-feedback" id="xcnp2" name="xcnp2" readonly=""/>
                            </div>
                        </td>

                        <td class="text-left">
                            <div class="form-group-sm">
                                <input type="number" class="form-control-feedback" id="xnloan2" name="xnloan2" onkeypress="return soloNumeros()"/>
                            </div>
                        </td>
                ...
                <tbody id="col3" class="hidden">
                    <tr>
                        ...
                        <td class="text-left">
                            <div class="form-group">
                                <input type="text" class="form-control" id="xidloan3" name="xidloan3" readonly="readonly"/>
                            </div>
                        </td>
                        ...
                        <td class="text-left">
                            <div class="form-group-sm">
                                <input type="number" class="form-control-feedback" id="xcnp3" name="xcnp3" readonly="" />
                            </div>
                        </td>

                        <td class="text-left">
                            <div class="form-group-sm">
                                <input type="number" class="form-control-feedback" id="xnloan3" name="xnloan3" onkeypress="return soloNumeros()"/>
                            </div>
                        </td>
                ...
                <tbody id="col4" class="hidden">
                    <tr>
                        ...
                        <td class="text-left">
                            <div class="form-group-sm">
                                <input type="number" class="form-control-feedback" id="xcnp4" name="xcnp4" readonly="" />
                            </div>
                        </td>

                        <td class="text-left">
                            <div class="form-group-sm">
                                <input type="number" class="form-control-feedback" id="xnloan4" name="xnloan4" onkeypress="return soloNumeros()"/>
                            </div>
                        </td>
                ...
                <tbody id="col5" class="hidden">
                    <tr>
                        ...
                        <td class="text-left">
                            <div class="form-group-sm">
                                <input type="number" class="form-control-feedback" id="xcnp5" name="xcnp5" readonly=""/>
                            </div>
                        </td>

                        <td class="text-left">
                            <div class="form-group-sm">
                                <input type="number" class="form-control-feedback" id="xnloan5" name="xnloan5" onkeypress="return soloNumeros()"/>
                            </div>
                        </td>
                        ...
                        <td class="text-left">
                            <div class="form-group-sm">
                                <input type="hidden" class="form-control-feedback" id="xidtool5" name="xidtool5" maxlength="150"/>
                            </div>
                        </td>
                    </tr>
                </tbody>
