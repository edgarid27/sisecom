...
<head>
	...
	<title>Panel principal de administración de almacenes.</title>
</head>
    ...
    <div class="container">
        ...
        <form id="formal" method="POST">
            ...
            <div class="form-group">
    			...
    			<input type="text" maxlength="50" onkeypress="return soloLetras(event)" class="form-control" id="xalmacen" name="xalmacen" placeholder="Almacen" />
    		</div>
